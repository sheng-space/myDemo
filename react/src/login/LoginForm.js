...
class LoginForm extends React.Component {
    ...
    onLogin = async (values) => {
        ...
        const res = await requestPost('/api/system/user/login', {
        ...
        //跳转首页
        router.push({pathname: "/index",query: {}});
    }
    /**
     * 生成验证码
     */
            ...
            <div>
                ...
                <Form hideRequiredMark>
                    <Form.Item
                        ...
                        label={<span className={style.iconfont} style={{ opacity: focusItem === 0 ? 1 : 0.6 }} />}
                        colon={false}>
                    ...
                    <Form.Item
                        ...
                        label={<span className={style.iconfont} style={{ opacity: focusItem === 2 ? 1 : 0.6 }} />}
                        colon={false}>
                        <Row gutter={8}>
                            <Col span={15}>
                    ...
                    <Form.Item>
                        <div className={style.btnbox}>
                            <div className={style.loginBtn} onClick={this.onSubmit}>登录</div>
                            <div className={style.registerBtn} onClick={this.goRegister}>注册</div>
                        </div>
                    </Form.Item>
                </Form>
                <div className={style.footer}>欢迎登陆后台管理系统</div>
            </div>
        )
    }
}
