...
import { debounce, encrypt } from '@/util/utils'
                ...
                <Form hideRequiredMark>
                    ...
                    <Form.Item>
                        <div className={style.btnbox}>
                            <div className={style.loginBtn} onClick={this.onSubmit}>注册</div>
                            <div className={style.registerBtn} onClick={this.backLogin}>返回登录</div>
                        </div>
                    </Form.Item>
                </Form>
